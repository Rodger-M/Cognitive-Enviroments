# -*- coding: utf-8 -*-
"""Cognitive Enviroments  - def

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1g-Xi2jhW3i-XxKavZIDQSWqm24NJCSCA
"""

!pip install opencv-python-headless streamlit pyngrok
...
!ngrok authtoken 2tNI7OfOHBMpZtSfjaVz2fr0RaR_YGGDc9PA79KMpFZ2b9NS

import os
import time
from pyngrok import ngrok

# Mata qualquer processo rodando na porta 8501
os.system("kill -9 $(lsof -t -i:8501)")

# Inicia o Streamlit corretamente com nohup (sem travar o Colab)
os.system("nohup streamlit run app.py --server.port 8501 &")

# Aguarda um tempo para garantir que o Streamlit iniciou
time.sleep(5)

# Conecta o ngrok à porta do Streamlit
public_url = ngrok.connect(8501).public_url
print(f"Streamlit rodando em: {public_url}")
